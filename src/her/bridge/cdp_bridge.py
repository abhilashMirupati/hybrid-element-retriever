...
def get_full_ax_tree(page: Optional[Page], include_frames: bool = True) -> List[Dict[str, Any]]:
...
def capture_complete_snapshot(
    ...
    # Get flattened DOM
    snapshot.dom_nodes = get_flattened_document(page, pierce=True, wait_stable=wait_stable)
    ...
    for host in shadow_hosts:
        try:
            ...
            """)
            if shadow_content:
                host_id = host.get_attribute("id") or host.get_attribute("class") or "unknown"
