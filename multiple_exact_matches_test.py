#!/usr/bin/env python3
"""
Multiple Exact Matches Test - Handle Multiple Elements with Same Text

This test handles cases where multiple elements have the exact same text.
"""
...
class MultipleExactMatchesTest:
    """Test that handles multiple elements with same exact text."""
    
    def __init__(self):
        """Initialize the test with real MarkupLM model."""
        print("🚀 Initializing Multiple Exact Matches Test")
        print("=" * 80)
    ...
    def run_multiple_matches_test(self):
        """Run the test with multiple exact matches."""
        print("🚀 Starting Multiple Exact Matches Test")
        print("=" * 80)
...
def run_multiple_exact_matches_test():
    """Run the multiple exact matches test."""
    print("🔍 Starting Multiple Exact Matches Test")
    print("=" * 80)
    
    try:
        test = MultipleExactMatchesTest()
        results = test.run_multiple_matches_test()
        return results
    except Exception as e:
...
if __name__ == "__main__":
    run_multiple_exact_matches_test()