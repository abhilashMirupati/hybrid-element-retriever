...
def test_comprehensive_attribute_analysis():
    """Test comprehensive attribute capture for all 3 CDP modes"""
...
def analyze_attributes():
    try:
        ...
        for mode, mode_name in modes:
            ...
            # Analyze first 10 elements in detail
            print(f"\\n🔍 DETAILED ELEMENT ANALYSIS (First 10):")
        ...
        print(f"\\n✅ COMPREHENSIVE ATTRIBUTE ANALYSIS COMPLETED")
...
if __name__ == "__main__":
    test_comprehensive_attribute_analysis()