...
Tests DOM/accessibility extraction for all 3 modes using subprocess isolation
"""
...
def test_simple_attribute_test():
    """Test simple attribute capture for all 3 CDP modes"""
    
    print("🔍 SIMPLE ATTRIBUTE TEST")
    print("=" * 80)
...
try:
    ...
    # Analyze first 2 interactive elements
    print(f"\\n🔍 INTERACTIVE ELEMENTS ANALYSIS (First 2):")
    for i, element in enumerate(interactive_elements[:2]):
...
"""
    ...
    print(f"\n✅ SIMPLE ATTRIBUTE TEST COMPLETED")

if __name__ == "__main__":
    test_simple_attribute_test()