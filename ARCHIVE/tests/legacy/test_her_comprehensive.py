...
def test_xpath_generation():
    ...
    from her.locator.simple_synthesize import LocatorSynthesizer
...
def test_cold_start_and_caching():
    ...
    with patch('src.her.bridge.snapshot.capture_snapshot') as mock_capture:
        ...
        if os.path.exists(cache_dir):
            ...
            total_size = sum(os.path.getsize('ignored'
...
def test_self_healing():
    ...
    from her.cli_api import HybridClient
    from her.recovery.enhanced_self_heal import EnhancedSelfHeal
