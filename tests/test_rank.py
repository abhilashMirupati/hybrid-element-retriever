...
from her.rank.heuristics import (
    heuristic_score,
    rank_by_heuristics,
    explain_heuristic_score,
)
...
class TestHeuristics:
    ...
    def test_heuristic_score_text_matching(self):
        ...
        descriptor = {"tag": "a", "text": "Click here to login", "href": "/login"}
    ...
    def test_explain_heuristic_score(self):
        ...
        descriptor = {"tag": "button", "text": "Login", "name": "login-btn"}
...
class TestFusion:
    ...
    def test_update_weights(self):
        ...
        assert (
            abs(fusion.config.alpha + fusion.config.beta + fusion.config.gamma - 1.0)
            < 0.01
        )
